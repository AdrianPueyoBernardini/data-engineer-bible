...
Es el proceso de entrenar un modelo para que realice *predicciones* útiles o *genere contenido*.
...
-**Imagen a texto:** Tras una entrada de imagen nos entrega texto.   
